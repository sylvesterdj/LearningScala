...
object staticStreamLeftOuterJoin extends App {
...
//    .withColumnRenamed("value", "id")
  ...
  val leftOuterJoinDS =  staticDepartmentDS.join(streamingEmployeeDS, $"id" === $"departmentId", "left_outer")

  val leftOuterJoinStream = leftOuterJoinDS.writeStream
    .format("console")
    .queryName("LeftOuterJoin")
    .trigger(Trigger.ProcessingTime("10 seconds"))
    .option("checkpointLocation", "sparkCheckPoint\\StaticStreamLeftOuterJoin\\cp2")
    .start()
