...
object streamStaticRightOuterJoin extends App {
...
//    .withColumnRenamed("value", "id")
  ...
  val rightOuterJoinDS  =  streamingEmployeeDS.join(staticDepartmentDS, $"departmentId" === $"id", "right_outer")

  val rightOuterJoinStream = rightOuterJoinDS.writeStream
    .format("console")
    .queryName("InnerJoin")
    .trigger(Trigger.ProcessingTime("10 seconds"))
    .option("checkpointLocation", "sparkCheckPoint\\streamStaticRightOuterJoin\\cp1")
    .start()
