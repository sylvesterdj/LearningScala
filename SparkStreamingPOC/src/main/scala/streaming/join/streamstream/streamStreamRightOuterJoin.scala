...
object streamStreamRightOuterJoin extends App {

  val spark: SparkSession = SparkSession.builder()
    .appName("streamStreamRightOuterJoin")
    .master("local[*]")
    .getOrCreate()
...
//    .withColumnRenamed("value", "id")
  ...
  val joinedStream = joinedDS.writeStream
    ...
    .option("checkpointLocation", "sparkCheckPoint\\streamStreamRightOuterJoin\\joinedTable")
