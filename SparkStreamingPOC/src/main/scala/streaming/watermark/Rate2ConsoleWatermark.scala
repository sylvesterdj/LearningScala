package streaming.watermark

import org.apache.log4j.{Level, LogManager}
import org.apache.spark.sql.SparkSession
import org.apache.spark.sql.streaming.Trigger

object Rate2ConsoleWatermark extends App {

  val spark: SparkSession = SparkSession.builder()
    .appName("Rate2ConsoleWatermark")
    .master("local[*]")
    .getOrCreate()
  ...
  val defaultStream = countData.writeStream
    ...
    .outputMode("complete")
    .option("checkpointLocation", "sparkCheckPoint\\Rate2ConsoleWatermark\\cp1")
    .start()
