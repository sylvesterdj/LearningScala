...
object Rate2ConsoleAggregateAppendMode extends App {

  val spark: SparkSession = SparkSession.builder()
    .appName("Rate2ConsoleAggregateAppendMode")
    .master("local[*]")
    .getOrCreate()
...
//    .outputMode("complete")
    .option("checkpointLocation", "sparkCheckPoint\\Rate2ConsoleAggregateAppendMode\\cp1")
    .start()
